  ...
  const getIngredientName = (id, data) => {
    ...
    const updatedArray = addedIngredientsArray.map(ingredient => {
      if (id === ingredient.id) {
        return (ingredient = {
          id: id,
          ingredientId: requstedIngredient ? requstedIngredient._id : '',
          ttl: data.ttl,
          ...
          {addedIngredientsArray.map(item => {
            return (
              <RecipeingredientsListItem
                ...
                getEmptyFieldData={getEmptyFieldData}
              ></RecipeingredientsListItem>
            );
          })}
        </RecipeIngredientsUl>
